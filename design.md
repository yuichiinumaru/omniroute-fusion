...
> **SSoT for design tokens / visual identity.** IA + sidebar rules live in [`docs/guides/UI.md`](docs/guides/UI.md). The typo doc `DESING.md` is **superseded** (stub + archive under `.archive/docs/2026-07-10-desing-typo/`).
>
