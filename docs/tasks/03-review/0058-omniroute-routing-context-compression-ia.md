...
- [x] 5. Compose enabled mode sections under settings.
  - [x] 5a. Read enabled engines from the same config source as `CompressionPanel`.
...
- [x] `/dashboard/context/settings` renders only enabled mode sections below settings.
