export const ANTIGRAVITY_PUBLIC_MODELS = Object.freeze([
  ...
  // Fork-retained public IDs that are not present in the upstream catalog but are
  // still accepted by the Antigravity runtime as direct upstream model IDs.
  {
...
const UPSTREAM_PUBLIC_MODEL_IDS = new Set(PUBLIC_MODEL_IDS);
