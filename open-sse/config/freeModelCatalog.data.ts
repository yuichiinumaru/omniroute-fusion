...
export const FREE_MODEL_BUDGETS: FreeModelBudget[] = [
  ...
  { provider: "aihubmix", modelId: "coding-kimi-k3-free", displayName: "Coding Kimi K3 (Free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "aihubmix", tos: "caution" },
  { provider: "aihubmix", modelId: "coding-glm-5.2-free", displayName: "Coding GLM 5.2 (Free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "aihubmix", tos: "caution" },
  { provider: "aihubmix", modelId: "gemini-3.7-flash-free", displayName: "Gemini 3.7 Flash (Free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "aihubmix", tos: "caution" },
  { provider: "aihubmix", modelId: "gemini-3.5-flash-lite-free", displayName: "Gemini 3.5 Flash Lite (Free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "aihubmix", tos: "caution" },
  ...
  { provider: "opencode", modelId: "hy3-free", displayName: "HY3 Free", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "opencode", tos: "avoid" },
  { provider: "opencode", modelId: "laguna-s-2.1-free", displayName: "Laguna S 2.1 Free", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "opencode", tos: "avoid" },
  { provider: "opencode", modelId: "mimo-v2.5-free", displayName: "MiMo V2.5 Free", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "opencode", tos: "avoid" },
  { provider: "opencode", modelId: "nemotron-3-ultra-free", displayName: "Nemotron 3 Ultra Free", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "opencode", tos: "avoid" },
  { provider: "opencode", modelId: "nemotron-3.5-lightning-free", displayName: "Nemotron 3.5 Lightning Free", monthlyTokens: 0, creditTokens: 0, freeType: "keyless", poolKey: "opencode", tos: "avoid" },
  // OpenCode Free rows: public/no-auth Free-tier models owned by provider
  // "opencode" (alias "oc"). Their upstream endpoint is shared with Zen, but
  // provider identity remains separate from "opencode-zen" API-key catalog rows.
  // All modelId values are bare; no provider prefix is embedded.
  { provider: "opencode-zen", modelId: "big-pickle", displayName: "Big Pickle (stealth)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  { provider: "opencode-zen", modelId: "deepseek-v4-flash-free", displayName: "DeepSeek V4 Flash (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  { provider: "opencode-zen", modelId: "hy3-free", displayName: "HY3 (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  { provider: "opencode-zen", modelId: "laguna-s-2.1-free", displayName: "Laguna S 2.1 (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  { provider: "opencode-zen", modelId: "mimo-v2.5-free", displayName: "MiMo V2.5 (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  { provider: "opencode-zen", modelId: "nemotron-3-ultra-free", displayName: "Nemotron 3 Ultra (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  { provider: "opencode-zen", modelId: "nemotron-3.5-lightning-free", displayName: "Nemotron 3.5 Lightning (free)", monthlyTokens: 0, creditTokens: 0, freeType: "recurring-uncapped", poolKey: "opencode-zen-free", tos: "caution" },
  ...
  { provider: "qoder", modelId: "lite", displayName: "Lite (Free)", monthlyTokens: 0, creditTokens: 1000000, freeType: "one-time-initial", poolKey: "qoder", tos: "caution" },
