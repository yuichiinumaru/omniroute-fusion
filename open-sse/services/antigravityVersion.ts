...
async function resolveProductVersion(
  ...
  state.inFlight = (async () => {
    ...
    if (resolved) {
      state.cache = { fetchedAt: Date.now(), version };
    }
    return version;
  })();
...
/** @deprecated Use resolveAntigravityIdeVersion for the IDE profile. */
export const resolveAntigravityVersion = resolveAntigravityIdeVersion;
/** @deprecated Use getCachedAntigravityIdeVersion for the IDE profile. */
export const getCachedAntigravityVersion = getCachedAntigravityIdeVersion;
/** @deprecated Use seedAntigravityIdeVersionCache for the IDE profile. */
export const seedAntigravityVersionCache = seedAntigravityIdeVersionCache;
/** @deprecated Use clearAntigravityVersionCaches to clear both product caches. */
export const clearAntigravityVersionCache = clearAntigravityVersionCaches;
