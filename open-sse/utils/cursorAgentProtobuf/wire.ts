...
// from ../cursorAgentProtobuf.ts (god-file decomposition). Pure and
// dependency-free (Buffer only): varint/tag/length-delimited encode+decode and the
// generic field walker. Higher-level frame, value, and message encoders/decoders
// build on this layer. Nothing here was part of the module's public API, so the
