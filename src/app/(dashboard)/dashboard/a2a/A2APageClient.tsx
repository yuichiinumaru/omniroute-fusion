...
/**
 * Conceptual intro / how-to for A2A Server.
 * Rendered at page top in standalone mode; fused stack hosts this under bottom explainers.
 */
export function A2AConceptIntro() {
  const t = useTranslations("a2aDashboard");
  return (
    <div>
...
export type A2APageClientProps = {
  /**
   * When true (Ops stack embed): hide concept intro; keep enable toggle + dashboard.
   * Concept intro is re-hosted under the fused page bottom explainers.
   */
  embedded?: boolean;
};

export default function A2APageClient({ embedded = false }: A2APageClientProps) {
  const t = useTranslations("a2aDashboard");
