...
export type BatchPageClientProps = {
  /** When false, concept card is omitted (Labs bottom explainer stack owns it). */
  showConceptCard?: boolean;
};

export default function BatchPageClient({ showConceptCard = true }: BatchPageClientProps = {}) {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Concept card (F3) — Labs fusion moves this to page-bottom explainers */}
      {showConceptCard ? <BatchConceptCard /> : null}
