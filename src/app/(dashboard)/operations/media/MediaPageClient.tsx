...
export default function MediaPageClient() {
  ...
  return (
    <div className="space-y-6" data-testid="media-page" data-media-page="">
      {/* Modality L1 strip — Media peer content chrome (not a second Ops hub topbar) */}
      <div
        className="flex flex-wrap gap-2 p-1 bg-surface/50 rounded-xl border border-black/5 dark:border-white/5"
        data-testid="media-modality-strip"
        data-media-modality-strip=""
        role="tablist"
        ...
        {(Object.keys(MODALITY_CONFIG) as Modality[]).map((key) => {
          ...
          return (
            <button
              ...
              data-modality={key}
              data-testid={`media-modality-${key}`}
